...
from library_manager import Book, LibraryManager, Loan, User
...
class TestLibraryManager(unittest.TestCase):
    ...
    def test_add_book_new(self):
        ...
        self.assertEqual(
            self.library.books[self.sample_book["isbn"]].title,
            self.sample_book["title"],
        )
        self.assertEqual(self.library.books[self.sample_book["isbn"]].total_copies, 2)
        self.assertEqual(
            self.library.books[self.sample_book["isbn"]].available_copies, 2
        )
    ...
    def test_borrow_book_success(self):
        ...
        result = self.library.borrow_book(
            self.sample_user["user_id"], self.sample_book["isbn"]
        )
    ...
    def test_search_books(self):
        ...
        self.library.add_book(
            "978-1", "Harry Potter e a Pedra Filosofal", "J.K. Rowling", 1997
        )
        self.library.add_book(
            "978-2", "Harry Potter e a Câmara Secreta", "J.K. Rowling", 1998
        )
